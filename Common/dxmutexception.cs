...
namespace Microsoft.Samples.DirectX.UtilityToolkit
{
    ...
    public class DirectXSampleException : ApplicationException
    {
    ...
    {
        public NoDirect3DException() : base(
        ...
        public NoDirect3DException(Exception inner) : base(
            "Could not initialize Direct3D. You may want to check that the latest version of DirectX is correctly installed on your system.",
            inner)
        {
        }
    ...
    public class NoCompatibleDevicesException : DirectXSampleException
    {
        ...
        public NoCompatibleDevicesException(Exception inner) : base("Could not find any compatible Direct3D devices.",
            inner)
        {
        }
    }
    ...
    public class MediaNotFoundException : DirectXSampleException
    {
        ...
        public MediaNotFoundException(Exception inner) : base(
            "Could not find required media. Ensure that the DirectX SDK is correctly installed.", inner)
        {
        }
    }
    ...
    public class ResettingDeviceObjectsException : DirectXSampleException
    {
        ...
        public ResettingDeviceObjectsException(Exception inner) : base("Failed resetting Direct3D device objects.",
            inner)
        {
        }
    }
